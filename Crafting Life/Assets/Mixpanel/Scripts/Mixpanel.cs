...
public static class Mixpanel
{
	...
	public static void SendEvent(string eventName, IDictionary<string, object> properties = null)
	{
		...
		propsDict.Add ("Game Session", PlayerPrefs.GetInt("TotalPlaycount"));
		propsDict.Add("Total Play Time", Utility.SecondsToTimeString(PlayerPrefs.GetFloat("TotalPlayTime")));

		//sets amount of time spent playing in both modes
		propsDict.Add("Play Time in Gathering", Utility.SecondsToTimeString(PlayerPrefs.GetFloat("GatheringPlayTime")));
		propsDict.Add("Play Time in Crafting", Utility.SecondsToTimeString(PlayerPrefs.GetFloat("CraftingPlayTime")));

		//sets count of play sessions in both modes
		propsDict.Add ("Session's Gathering Play Count", GlobalVars.GATHERING_PLAY_COUNT);
		propsDict.Add("Session's Crafting Play Count", GlobalVars.CRAFTING_PLAY_COUNT);
